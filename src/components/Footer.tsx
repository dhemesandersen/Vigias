        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-3 flex flex-col items-start lg:items-end">
             ...
             <div className="flex flex-wrap gap-4 mb-10 justify-start lg:justify-end">
                ...
                <a href="https://pt.pinterest.com/vigias_pt/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[#E8E6E1]/30 flex items-center justify-center hover:bg-[#E8E6E1] hover:text-[#2e2624] transition-all">
                ...
                <a href="https://www.youtube.com/@vigias_pt" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[#E8E6E1]/30 flex items-center justify-center hover:bg-[#E8E6E1] hover:text-[#2e2624] transition-all">
