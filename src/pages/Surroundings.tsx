            ...
            <div className="w-full lg:w-7/12">
               <div className="w-full h-full min-h-[600px] lg:min-h-[900px] bg-gray-100 overflow-hidden relative">
                  <iframe 
                    src={
                        lang === 'pt' 
                        ? "https://www.youtube.com/embed/yWMFi3b5oOg?autoplay=1&mute=1&loop=1&playlist=yWMFi3b5oOg&playsinline=1&controls=0&showinfo=0&rel=0&modestbranding=1&start=20&end=27" 
                        : lang === 'es'
                        ? "https://www.youtube.com/embed/gp3L3MIr1Nk?autoplay=1&mute=1&loop=1&playlist=gp3L3MIr1Nk&playsinline=1&controls=0&showinfo=0&rel=0&modestbranding=1"
                        : "https://www.youtube.com/embed/-uBa-MJf4RY?autoplay=1&mute=1&loop=1&playlist=-uBa-MJf4RY&playsinline=1&controls=0&showinfo=0&rel=0&modestbranding=1"
                    }
