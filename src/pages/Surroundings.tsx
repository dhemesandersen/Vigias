            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
               ...
               <div className="font-sans font-light text-[#2e2624]/70 leading-relaxed space-y-6 text-justify md:text-left pt-0 lg:pt-24">
                  ...
                  <p className="text-sm md:text-[15px]">
                    ...
                    {lang === 'es' && "Las Vigias se esconden en la inmensidad del Parque Natural de la Sierra de S. Mamede, un enclave geológico que cria un microclima de excepción en el Alentejo."}
