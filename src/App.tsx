...
const router = createBrowserRouter([
  ...
  ...languages.map(lang => ({
    ...
    children: [
      ...
      { path: lang === 'pt' || lang === 'es' ? 'casas' : 'houses', element: <HousesList lang={lang} /> },
      { path: lang === 'pt' || lang === 'es' ? 'casas/:id' : 'houses/:id', element: <SingleHouse lang={lang} /> },
      // Mapping the "Envolvente" page
      { path: lang === 'pt' ? 'envolvente' : lang === 'es' ? 'entorno' : 'surroundings', element: <Surroundings lang={lang} /> },
      // Mapping the "Vigias" (About) page
      { path: lang === 'pt' || lang === 'es' ? 'vigias' : 'about', element: <About lang={lang} /> },
      // Mapping the "Experiências" page
      { path: lang === 'en' ? 'experiences' : 'experiencias', element: <Experiences lang={lang} /> },
      // Mapping the "Reservas" page
      { path: lang === 'en' ? 'book' : 'reservas', element: <Book lang={lang} /> },
      // Mapping the "Contacto" page
      { path: lang === 'en' ? 'contact' : 'contacto', element: <Contact lang={lang} /> },
      // Blog
      { path: 'blog', element: <BlogList lang={lang} /> },
      { path: 'blog/:slug', element: <BlogPost lang={lang} /> },
      // Privacy and Terms routes
      { path: lang === 'pt' ? 'politica-de-privacidade' : lang === 'es' ? 'politica-de-privacidad' : 'privacy-policy', element: <PrivacyPolicy lang={lang} /> },
